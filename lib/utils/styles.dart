//this is where the constants for apps go eg borderradius, padding, screensizes, fonts,
//textstyles, fontsizes, shadows, corners, sizes, iconsizes,durations, ,margins

//this handles the border radiuses in the app. they can be small , medius or large.
...
//this handles the durations of animations used in the app
...
//this handles all the box shadows in the app, can be customized
...
//this class handles the screen sizes of the targeted devices with the user interface
...
//this class targets the icon sizes in the app can be customize to add large
